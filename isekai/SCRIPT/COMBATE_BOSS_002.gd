# COMBATE_BOSS_002.gd - Sistema de combate Y animaciones para BOSS_2
extends Node
...
var boss_2: AnimatedSprite2D = null
...
func inicializar(
	...
	_ani_escudo_fisico: AnimatedSprite2D, _ani_escudo_especial: AnimatedSprite2D, _boss_2: AnimatedSprite2D,
	_callback: Callable
):
	lbl_deff = _lbl_deff
	...
	print("✅ Sistema de combate BOSS_2 inicializado")
...
func aplicar_daño_a_vida(cantidad: int) -> int:
	...
	print("💥 Daño a BOSS_2: ", cantidad, " | Vida restante: ", vida_nueva)
...
func reiniciar_contadores_escudos():
	...
	actualizar_ui_escudo_fisico()
	actualizar_ui_escudo_especial()
	print("🔄 Contadores de escudos BOSS_2 reiniciados a 0")
...
func _hit_boss():
	if boss_muerto:
		return
	if boss_2 and boss_2.sprite_frames and boss_2.sprite_frames.has_animation("HIT"):
		print("  ➤ BOSS_2 recibe HIT")
		boss_2.play("HIT")
...
func _muerte_boss():
	print("💀 BOSS_2 DERROTADO - Reproduciendo MUERTE")
	if boss_2 and boss_2.sprite_frames and boss_2.sprite_frames.has_animation("MUERTE"):
		boss_2.play("MUERTE")
	else:
		print("❌ Animación MUERTE no encontrada en BOSS_2")
...
func ejecutar_daño_fisico(cantidad_golpes: int, contador_original: int):
	if boss_muerto:
		print("⚠️ BOSS_2 ya está muerto, no se ejecuta daño físico")
		return
	
	print("🎬 ===== INICIO SECUENCIA GOLPES FÍSICOS BOSS_2 =====")
	...
	for i in range(cantidad_golpes):
		...
		print("")
		print("  🔹 Golpe FÍSICO BOSS_2 ", i + 1, " de ", cantidad_golpes)
	...
	print("🎬 ===== FIN SECUENCIA GOLPES FÍSICOS BOSS_2 =====")

func ejecutar_daño_especial(cantidad_golpes: int, contador_original: int):
	if boss_muerto:
		print("⚠️ BOSS_2 ya está muerto, no se ejecuta daño especial")
		return
	
	print("🎬 ===== INICIO SECUENCIA GOLPES ESPECIALES BOSS_2 =====")
	print("🔢 Cantidad de golpes: ", cantidad_golpes)
	...
	for i in range(cantidad_golpes):
		...
		print("")
		print("  🔹 Golpe ESPECIAL BOSS_2 ", i + 1, " de ", cantidad_golpes)
	...
	print("🎬 ===== FIN SECUENCIA GOLPES ESPECIALES BOSS_2 =====")

func ejecutar_daño_directo(cantidad_golpes: int, contador_original: int):
	if boss_muerto:
		print("⚠️ BOSS_2 ya está muerto, no se ejecuta daño directo")
		return
	
	print("🎬 ===== INICIO SECUENCIA GOLPES DIRECTOS BOSS_2 =====")
	print("🔢 Cantidad de golpes: ", cantidad_golpes)
	...
	print("  🛡️ Escudo Físico BOSS_2: ", escudo_fisico_actual)
	print("  🛡️ Escudo Especial BOSS_2: ", escudo_especial_actual)
	...
	for i in range(cantidad_golpes):
		...
		print("")
		print("  🔹 Golpe DIRECTO BOSS_2 ", i + 1, " de ", cantidad_golpes)
	...
	print("🎬 ===== FIN SECUENCIA GOLPES DIRECTOS BOSS_2 =====")
